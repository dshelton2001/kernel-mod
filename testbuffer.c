...
#define BUFFER_LENGTH 129              ///< The buffer length (crude but fine)
...
int main(int argc, char *argv[])
{
    ...
    char str2[BUFFER_LENGTH] = "d2NrbPAsdsJOlDuo5avTEVGXpe8KW5GWASkxUwBvv1DRzG49IsX3Aadt07LNmXoON9W2bOA1d2NrbPAsdsJOlDuo5avTEVGXpe8KW5GWASkxUwBvv1DRzG49IsX3Aad!";
